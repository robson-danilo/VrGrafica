<html>
  ...
  <a-scene>
        <a-assets>
            ...
            <img id="r4" src="<?php echo base_url(); ?>/imagens3/r4.jpg">
            <img id="r5" src="<?php echo base_url(); ?>/imagens3/r5.jpg">
            <img id="r6" src="<?php echo base_url(); ?>/imagens3/r6.jpg">
            <img id="r7" src="<?php echo base_url(); ?>/imagens3/r7.jpg">
            <img id="p1" src="<?php echo base_url(); ?>/imagens3/p1.jpg">
            <img id="p2" src="<?php echo base_url(); ?>/imagens3/p2.jpg">
            <img id="p3" src="<?php echo base_url(); ?>/imagens3/p3.jpg">
            <img id="p4" src="<?php echo base_url(); ?>/imagens3/p4.jpg">
            <img id="p5" src="<?php echo base_url(); ?>/imagens3/p5.jpg">
            <img id="p6" src="<?php echo base_url(); ?>/imagens3/p6.jpg">
            <img id="p7" src="<?php echo base_url(); ?>/imagens3/p7.jpg">
            <img id="p8" src="<?php echo base_url(); ?>/imagens3/p8.jpg">
            <img id="p9" src="<?php echo base_url(); ?>/imagens3/p9.jpg">
            <img id="p10" src="<?php echo base_url(); ?>/imagens3/p10.jpg">
            <img id="p11" src="<?php echo base_url(); ?>/imagens3/p11.jpg">
            <img id="p12" src="<?php echo base_url(); ?>/imagens3/p12.jpg">
            <img id="p13" src="<?php echo base_url(); ?>/imagens3/p13.jpg">
            <img id="p14" src="<?php echo base_url(); ?>/imagens3/p14.jpg">
            <img id="p15" src="<?php echo base_url(); ?>/imagens3/p15.jpg">
            <img id="p16" src="<?php echo base_url(); ?>/imagens3/p16.jpg">
            <img id="p17" src="<?php echo base_url(); ?>/imagens3/p17.jpg">
            <img id="p18" src="<?php echo base_url(); ?>/imagens3/p18.jpg">
            <img id="p19" src="<?php echo base_url(); ?>/imagens3/p19.jpg">
            <img id="f1" src="<?php echo base_url(); ?>/imagens3/f1.jpg">
            <img id="f2" src="<?php echo base_url(); ?>/imagens3/f2.jpg">
            <img id="f3" src="<?php echo base_url(); ?>/imagens3/f3.jpg">
            <img id="f4" src="<?php echo base_url(); ?>/imagens3/f4.jpg">
            <img id="f5" src="<?php echo base_url(); ?>/imagens3/f5.jpg">
            <img id="f6" src="<?php echo base_url(); ?>/imagens3/f6.jpg">
            <img id="f7" src="<?php echo base_url(); ?>/imagens3/f7.jpg">
            <img id="f8" src="<?php echo base_url(); ?>/imagens3/f8.jpg">
            <img id="f9" src="<?php echo base_url(); ?>/imagens3/f9.jpg">
            <img id="f10" src="<?php echo base_url(); ?>/imagens3/f10.jpg">
            <img id="f11" src="<?php echo base_url(); ?>/imagens3/f11.jpg">
            <img id="f12" src="<?php echo base_url(); ?>/imagens3/f12.jpg">
            <img id="f13" src="<?php echo base_url(); ?>/imagens3/f13.jpg">
            <img id="f14" src="<?php echo base_url(); ?>/imagens3/f14.jpg">
            <img id="f15" src="<?php echo base_url(); ?>/imagens3/f15.jpg">
            <img id="f16" src="<?php echo base_url(); ?>/imagens3/f16.jpg">
            <img id="f17" src="<?php echo base_url(); ?>/imagens3/f17.jpg">
            <img id="f18" src="<?php echo base_url(); ?>/imagens3/f18.jpg">
            <img id="f19" src="<?php echo base_url(); ?>/imagens3/f19.jpg">
            <img id="l1" src="<?php echo base_url(); ?>/imagens3/l1.jpg">
            <img id="l2" src="<?php echo base_url(); ?>/imagens3/l2.jpg">
            <img id="l3" src="<?php echo base_url(); ?>/imagens3/l3.jpg">
